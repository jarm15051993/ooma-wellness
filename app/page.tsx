...
<section id="hero">
  ...
  <div class="hero-inner">
    ...
    <div class="hero-ctas h-a6">
      <a href="/signup" class="btn-hero-p">Me interesa</a>
  ...
  <div class="footer-grid">
    ...
    <div>
      ...
      <p style="font-size:12.5px;color:var(--mgray);line-height:2.0;font-weight:300;">
        ...
        <a href="mailto:admin@oomawellness.shop" style="color:var(--terra);text-decoration:none;">admin@oomawellness.shop</a><br>
        <a href="https://wa.me/34744432128" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:7px;color:var(--mgray);text-decoration:none;margin-top:6px;transition:color .2s;" onmouseover="this.style.color='#25D366'" onmouseout="this.style.color='var(--mgray)'">
