...
interface SendEmailOptions {
  to: string
  type: 'activation' | 'password_reset' | 'email_verification' | 'booking_confirmation' | 'booking_cancellation' | 'package_purchase' | 'gift_class' | 'class_cancelled' | 'student_status_granted' | 'student_status_removed'
